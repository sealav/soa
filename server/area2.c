...
void shrine_driver(int in,int cn)
{
	...
	if (type==0) {
		...
		switch(r) {
			...
			case 3:
			case 4:
			case 5:		in2=create_item("zombie_skull2"); break;
			case 6:		in2=create_item("zombie_skull2"); break;
			case 7:		in2=create_item("zombie_skull2"); break;
			case 8:		in2=create_item("zombie_skull2"); break;
			case 9:		in2=create_item("torch"); break;
			
			case 10:	in2=create_item("zombie_skull2"); break;
			case 11:        if (ch[cn].flags&CF_MAGE) in2=create_item("mana_potion1");
					else in2=create_item("healing_potion1");
					
					break;
			
			case 12:	in2=create_item("zombie_skull2"); break;
			...
			case 20:	in2=create_item("zombie_skull2"); break;
