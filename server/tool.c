...
struct special_item special_item[]={
        {"Wisdom",			{V_WIS,-1,-1},				SP_LOTS,	0,		0,	1},
	{"Intuition",			{V_INT,-1,-1},				SP_LOTS,	0,		0,	1},
	{"Agility",			{V_AGI,-1,-1},				SP_LOTS,	0,		0,	1},
	{"Strength",			{V_STR,-1,-1},				SP_LOTS,	0,		0,	1},
	
	{"Hitpoints",			{V_HP,-1,-1},				SP_LOTS,	0,		0,	1},
	{"Mana",			{V_MANA,-1,-1},				SP_LOTS,	0,		0,	1},
	{"Endurance",			{V_ENDURANCE,-1,-1},			SP_LOTS,	0,		0,	1},

	//{"Axe",      			{V_AXE,-1,-1},				SP_SOME,	IF_AXE,		0,	2},
	{"Dagger",			{V_DAGGER,-1,-1},			SP_MANY,	IF_DAGGER,	0,	2},
	{"Hand to Hand",		{V_HAND,-1,-1},				SP_MANY,	0,		0,	2},
	{"Staff",			{V_STAFF,-1,-1},			SP_MANY,	IF_STAFF,	0,	2},
	{"Sword",			{V_SWORD,-1,-1},			SP_MANY,	IF_SWORD,	0,	2},
	{"Two-Handed",			{V_TWOHAND,-1,-1},			SP_MANY,	IF_TWOHAND,	0,	2},

	{"Attack",			{V_ATTACK,-1,-1},			SP_MANY,	0,		0,	2},
	{"Parry",			{V_PARRY,-1,-1},			SP_MANY,	0,		0,	2},
	{"Warcry",			{V_WARCRY,-1,-1},			SP_MANY,	0,		0,	1},
	{"Tactics",			{V_TACTICS,-1,-1},			SP_MANY,	0,		0,	2},
	...
	{"Thief",			{V_STEALTH,V_ENDURANCE,-1},		SP_SOME,		0,		1,	4},
	{"Vision",			{V_PERCEPT,V_INT,-1},			SP_SOME,		0,		0,	4},
	{"Wounded",			{V_HEAL,V_REGENERATE,-1},		SP_SOME,		0,		1,	4},
	{"Eccentric",			{V_BODYCONTROL,V_BLESS,V_SPEEDSKILL},	SP_SOME,		0,		1,	4},
	{"Sorcery",			{V_MANA,V_DURATION,-1},			SP_SOME,		0,		0,	8},

	{"Fighting",			{V_ATTACK,V_PARRY,-1},			SP_SOME,	0,		0,	8},
	{"Magic",			{V_FLASH,V_MAGICSHIELD,-1},		SP_SOME,	0,		0,	8},
	{"Berserk",			{V_ATTACK,V_RAGE,-1},			SP_SOME,	0,		0,	8},
	
        {"One Handed Offense",		{V_ATTACK,V_SWORD,-1},			SP_SOME,	IF_SWORD,	0,	8},
	{"One Handed Defense",		{V_PARRY,V_SWORD,-1},			SP_SOME,	IF_SWORD,	0,	8},
        {"Two Handed Offense",		{V_ATTACK,V_TWOHAND,-1},		SP_SOME,	IF_TWOHAND,	0,	8},
	{"Two Handed Defense",		{V_PARRY,V_TWOHAND,-1},			SP_SOME,	IF_TWOHAND,	0,	8},

	{"Tactical Offense",		{V_ATTACK,V_TACTICS,-1},		SP_SOME,	0,		0,	8},
	{"Tactical Defense",		{V_PARRY,V_TACTICS,-1},			SP_SOME,	0,		0,	8},

	{"Magical Offense",		{V_FLASH,V_FIREBALL,V_PULSE},		SP_SOME,	0,		0,	8},
	{"Magical Defense",		{V_MAGICSHIELD,V_FREEZE,V_HEAL},	SP_SOME,	0,		0,	8},

	{"Warrior",			{V_ATTACK,V_PARRY,V_IMMUNITY},		SP_RARE,	0,		1,	16},
	{"Mage",			{V_FLASH,V_MAGICSHIELD,V_IMMUNITY},	SP_RARE,	0,		1,	16},
	{"Tactician",			{V_ATTACK,V_PARRY,V_TACTICS},		SP_RARE,	0,		1,	16},
	{"Seyan'Du",			{V_ATTACK,V_PARRY,V_BLESS},		SP_RARE,	0,		1,	16},
	{"Arch-Warrior",		{V_ATTACK,V_PARRY,V_RAGE},		SP_RARE,	0,		1,	16},
	{"Arch-Mage",			{V_FLASH,V_MAGICSHIELD,V_DURATION},	SP_RARE,	0,		1,	16}
};
