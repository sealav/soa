...
struct qa qa[]={
	...
	{{"fuck","you",NULL},"Sorry %s I am Married!",0},
...
void generate_demon_mission(int lvl,struct military_ppd *ppd)
{
	...
	ppd->mis[0].pts=2;						// worth one military point
	...
	ppd->mis[1].pts=4;						// worth one military point
	...
	ppd->mis[2].pts=8;						// worth one military point
	...
	ppd->mis[3].pts=20;						// worth one military point
	...
	ppd->mis[4].pts=50;						// worth one military point
